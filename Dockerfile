FROM ubuntu:noble
WORKDIR /root/src
ADD https://ftp.gnu.org/gnu/binutils/binutils-2.43.1.tar.gz /root/src/
...
RUN apt-get update && apt-get -y upgrade; \
    ...
    ../binutils-2.43.1/configure --target=$TARGET --prefix="$PREFIX" --disable-multilib --disable-nls --disable-werror; \
